								...
								<div>
                                 ...
                                 <div class="form-group">
											...
											<div class="form-group">
												...
												<input class="form-control" id="berat" type="text" name="berat" value="<?php echo$jumber?>" disabled />
											</div>
						...
						<div class="col-md-8">
							<div class="panel panel-success">
								...
								<div class="panel-body">
                                    ...
                                    <button id="submit-checkout-button" type="submit" name="submit" class="btn button button-primary " >Checkout</button>
                                 </div>
                                 </form>
                              </div>
                           </div>
	...
	$(document).ready(function(){
		$('#provinsi').change(function(){
			...
			var prov = $('#provinsi').val();
      		...
      		$.ajax({
            	type : 'GET',
           		url : 'http://localhost/adolbarang.id/ongkir_proses/cek_kabupaten.php',
            	data :  'prov_id=' + prov,
		...
		$("#kabupaten").change(function(){
			...
			var berat = $('#berat').val();
      		...
      		$.ajax({
            	type : 'POST',
           		url : 'http://localhost/adolbarang.id/ongkir_proses/cek_ongkir.php',
        ...
        $("#kurir").change(function(){
         ...
         $('#kurir').change(function(){
            ...
            var berat = $('#berat').val();
      		...
      		$.ajax({
            	type : 'POST',
           		url : 'http://localhost/adolbarang.id/ongkir_proses/cek_layanan.php',
            	data :  {'kab_id' : kab, 'kurir' : kurir, 'asal' : asal, 'berat' : berat},
					success: function (data) {
