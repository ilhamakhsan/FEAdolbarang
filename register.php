            ...
            <div id="checkout-wrapper" style="min-height: 100vh">
               <div class="row">
                  <div class="col-md-7 col-md-offset-3 white-wrapper">
                              <div class="page-section-title" align="center">Register</div>
                              <div class="page-section-title">Data Pengguna</div>
                              <div class="form-group">
                                 ...
                                 <div   style="text-align: left; padding-bottom: 0" class="add-address form">
                                    <div id="wrapper-ajah" style="padding:0;margin-top:10px">
                                       <div class="form-group"><label for="Nama Pertama">Nama Pertama</label><input id="address-firstname" name="billing_first_name" type="text" required placeholder="" class="form-control"></div>
                                       <div class="form-group"><label for="Nama Akhir">Nama Akhir</label><input id="address-lastname" name="billing_last_name" type="text" required placeholder="" class="form-control"></div>
                                       <div class="form-group"><label for="Email">Email</label><input id="address-email" name="billing_email" type="tel" required placeholder="" class="form-control"></div>
                                       <div class="form-group"><label for="password">Password</label><input id="address-email" name="password" type="tel" required placeholder="" class="form-control"></div>
                                       <div class="form-group"><label for="Phone">Phone</label><input id="address-phone" name="billing_phone" type="text" required placeholder="" class="form-control"></div>
									            <div class="form-group"><label for="Perusahaan">Perusahaan</label><input id="address-company" name="billing_company" type="text" required placeholder="" class="form-control"></div>
                                       <div class="form-group"><label for="Alamat">Alamat</label><input id="address" name="billing_address_1" type="text" required placeholder="" class="form-control"></div>
									            <div class="form-group"><label for="Negara">Negara</label><input id="address-country" name="billing_country" type="text" required placeholder="" class="form-control"></div>
									            <div class="form-group"><label for="Provinsi">Provinsi</label><input id="address-province" name="billing_state" type="text" required placeholder="" class="form-control"></div>
									            <div class="form-group"><label for="Kota">Kota</label><input id="address-kota" name="billing_city" type="text" required placeholder="" class="form-control"></div>
                                       <div class="form-group"><label for="Kode Pos">Kode Pos</label><input id="postal_code" name="billing_postal_code" type="" required placeholder="" class="form-control"></div>
									...
									<button id="submit-checkout-button" type="submit" name="submit" class="btn button button-primary disabled" align="center">Daftar</button>
                                 </div>
                                 </form>
                              </div>
                           </div>
